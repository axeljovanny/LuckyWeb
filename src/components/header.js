          ...
          >
            ...
            <STextoInicio>
              ...
              >
                ...
                <span>
                  {" "}
                  <Trans>HEADER_CREATIVIDAD</Trans>{" "}
                </span>{" "}
                <span class="Es">
                  <Trans>HEADER_ES</Trans>
                </span>{" "}
                <span class="Es">
                  <Trans>HEADER_UN</Trans>
                </span>{" "}
                <span>
                  <Trans>HEADER_REFLEJO</Trans>
                </span>{" "}
                <span class="Es">
                  <Trans>HEADER_DE</Trans>
                </span>{" "}
                <span>
                  <Trans>HEADER_NUESTRA</Trans>
                </span>{" "}
